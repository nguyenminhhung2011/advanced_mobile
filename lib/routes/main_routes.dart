...
import 'package:lettutor/clean_architectures/presentation/auth/bloc/register/register_bloc.dart';
import 'package:lettutor/clean_architectures/presentation/auth/bloc/reset/reset_pass_bloc.dart';
import 'package:lettutor/clean_architectures/presentation/auth/bloc/sign_in/auth_bloc.dart';
import 'package:lettutor/clean_architectures/presentation/auth/views/register_screen.dart';
import 'package:lettutor/clean_architectures/presentation/auth/views/reset_screen.dart';
import 'package:lettutor/clean_architectures/presentation/auth/views/sign_in_screen.dart';
import 'package:lettutor/clean_architectures/presentation/become_tutor/bloc/become_tutor_bloc.dart';
import 'package:lettutor/clean_architectures/presentation/become_tutor/views/become_tutor_view.dart';
import 'package:lettutor/clean_architectures/presentation/before_meeting/views/before_meeting_view.dart';
import 'package:lettutor/clean_architectures/presentation/course_detail/bloc/course_detail_bloc.dart';
import 'package:lettutor/clean_architectures/presentation/course_detail/views/course_detail_screen.dart';
import 'package:lettutor/clean_architectures/presentation/course_detail/views/pdf_view_page.dart';
import 'package:lettutor/clean_architectures/presentation/dashboard/bloc/dashboard_bloc.dart';
import 'package:lettutor/clean_architectures/presentation/dashboard/views/dashboard_views.dart';
import 'package:lettutor/clean_architectures/presentation/e_boo/bloc/e_boo_bloc.dart';
import 'package:lettutor/clean_architectures/presentation/e_boo/views/e_boo_view.dart';
...
import 'package:lettutor/clean_architectures/presentation/meeting/view/meeting_view.dart';
import 'package:lettutor/clean_architectures/presentation/ratting/bloc/ratting_bloc.dart';
import 'package:lettutor/clean_architectures/presentation/ratting/views/ratting_view.dart';
...
import 'package:lettutor/clean_architectures/presentation/search_tutor/views/search_tutor_result.dart';
import 'package:lettutor/clean_architectures/presentation/search_tutor/views/search_tutor_view.dart';
import 'package:lettutor/clean_architectures/presentation/splash/bloc/slash_bloc.dart';
import 'package:lettutor/clean_architectures/presentation/splash/views/splash_screen.dart';
import 'package:lettutor/clean_architectures/presentation/tutor_detail/bloc/tutor_detail_bloc.dart';
import 'package:lettutor/clean_architectures/presentation/tutor_detail/views/tutor_detail_screen.dart';
import 'package:lettutor/clean_architectures/presentation/tutor_schedule/bloc/tutor_schedule_bloc.dart';
import 'package:lettutor/clean_architectures/presentation/tutor_schedule/views/tutor_schedule_screen.dart';
